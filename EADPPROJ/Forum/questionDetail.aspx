							...
							<div class="kt-portlet">
								...
								<div class="kt-portlet__body">
									<div class="kt-blog-post">
										<h1 class="kt-blog-post__title kt-heading kt-heading--lg kt-heading--medium" runat="server" id="title">
										</h1>
										<div class="kt-blog-post__meta">
											...
											<div class="kt-blog-post__author">
												By <asp:HyperLink ID="Username" runat="server"></asp:HyperLink>
											</div>
											<div class="kt-blog-post__comments">
                                                <asp:Label ID="answerCount" runat="server"></asp:Label> Answers
											</div>
										</div>
                                ...
                                <div style="display:none" runat="server" id="BestAnswerBlock">
                                    <div class="kt-portlet__body">
                                                            ...
                                                            <asp:Label ID="bestAnswerPostTime" runat="server"></asp:Label>
                                                                ...
                                                                <div class="kt-blog-post__author">
												                    By <asp:HyperLink ID="bestAnswerUsername" runat="server"></asp:HyperLink>
                                                                    </div>
                                                                </div>  
                                                            <br />
                                                            <div class="kt-blog-post__content">
                                                    ...
                                                    <asp:TemplateField HeaderText="AnswerDetail">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="answerPostTime" runat="server" Text='<%# Eval("PostTime", "{0}") %>'></asp:Label>
                                                                ...
                                                                <div class="kt-blog-post__author">
												                    By <asp:HyperLink ID="answerUsername" runat="server" Text='<%# Eval("Username", "{0}") %>'></asp:HyperLink>
                                                                    </div>
                                                                </div>  
                                                            <br />
                                                            <div class="kt-blog-post__content">
