										...
										<div class="kt-portlet__head">
											...
											<div class="kt-portlet__head-toolbar">
												<ul class="nav nav-tabs nav-tabs-bold nav-tabs-line nav-tabs-line-brand" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-toggle="tab" href="#kt_portlet_tabs_1_1_content" role="tab">
															Balance
														</a>
													</li>
													<li class="nav-item">
										...
										<div class="row row-no-padding">
												...
												<div class="kt-pricing-v1 kt-pricing-v1--danger">
													...
													<div class="kt-pricing-v1__body">
														...
														<div class="kt-pricing-v1__button">
															<a href="./creditTopUp.aspx"><button type="button" class="btn btn-primary btn-pill btn-widest btn-taller btn-bold">Top Up More</button></a>
														</div>
													</div>
												</div>
											</div>
											<div class="col-lg-12 col-xl-3">
												<div class="kt-pricing-v1 kt-pricing-v1--success">
													...
													<div class="kt-pricing-v1__body">
														...
														<div class="kt-pricing-v1__button">
															<a data-toggle="tab" href="#kt_portlet_tabs_1_2_content"><button type="button" class="btn btn-primary btn-pill btn-widest btn-taller btn-bold">Check</button></a>
														</div>
													</div>
												</div>
											</div>
											<div class="col-lg-12 col-xl-3">
												<div class="kt-pricing-v1 kt-pricing-v1--warning">
													...
													<div class="kt-pricing-v1__body">
														<div class="kt-pricing-v1__content">
															Total credits spent in the sytem.
														</div>
														<div class="kt-pricing-v1__price">
													...
													<table class="table table-head-noborder">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
																...
																<td><%# Eval("Id") %></td>
																<td><%# Eval("PostTime") %></td>
																<td><a href="./invoice.aspx?id=<%#Eval("Id").ToString() %>"><button type="button" class="btn btn-focus btn-elevate btn-elevate-air btn-pill btn-success">View Invoice Detail</button></a></td>
															</tr>
                                                        </ItemTemplate>
                                                        <FooterTemplate>
                                                            </tbody>
