            ...
            <div class="section">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" BorderStyle="None" GridLines="None" ShowHeader="False" Width="100%">
                        <Columns>
                            ...
                            <div class="card-body">
                                ...
                                <h3 class="card-title" style="height:100px"><%# Eval("Title", "{0}") %></h3>
                ...
                <div class="row">
                    <div class="col-md-12 ml-auto mr-auto" >
                        <asp:DataList ID="DataList1" runat="server" DataKeyField="Id" DataSourceID="SqlDataSource2" RepeatColumns="2" RepeatDirection="Horizontal" Width="100%">
                            <ItemTemplate>
                                <div class="col-md-12">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-description" style="overflow:hidden;height:150px">
                                    <%# Eval("Content", "{0}") %>
                                </div>
                    ...
                    <div class="tab-pane " id="pill3">
                        <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [tb_Blog] ORDER BY [Favorite] DESC, [Id] DESC">
                                </asp:SqlDataSource>
                        </div>
                        </div>
                        </div>
                    <div class="tab-pane" id="pill4">
                        <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [tb_Blog] ORDER BY [Tip] DESC, [Id] DESC">
                                </asp:SqlDataSource>
                        </div>
                        </div>
                    </div>
