<%@ Page Title="" Language="C#" MasterPageFile="~/Blog/MasterPageBlog.Master" AutoEventWireup="true" CodeBehind="blogDetail.aspx.cs" Inherits="EADPPROJ.WebForm2" %>
    ...
    <asp:Panel ID="successSet" runat="server" Visible="false">
        <div class="alert alert-success" style="margin-bottom: 0">
            <div class="container">
                ...
                <b>Success :</b> This blog has been set as highlight blog post!
            </div>
        </div>
    </asp:Panel>
