    ...
    <div class="form-group" style="text-align: center">
        <div class="form-check">
            <label class="form-check-label">
                <input class="form-check-input" type="radio" name="identity" runat="server" id="identityStudent" />
                Student
                <span class="circle">
        ...
        <div class="form-check">
            <label class="form-check-label">
                <input class="form-check-input" type="radio" name="identity" runat="server" id="identityTeacher" />
                Teacher
                <span class="circle">
                    <span class="check"></span>
                </span>
